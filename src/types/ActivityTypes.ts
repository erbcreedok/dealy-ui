...
export type EveryActivity = EmptyActivity | ServiceActivity | ServiceMultiActivity

export const ActivityColors: Record<ActivityStatus, { color: Color, background: Color, border: Color }> = {
    [ActivityStatus.passed]: {
        color: COLORS.black,
        background: getAlpha(COLORS.blue, .1),
        border: getAlpha(COLORS.blue, .5)
    },
    [ActivityStatus.current]: {
        color: COLORS.black,
        background: COLORS.bg,
        border: getAlpha(COLORS.lightGrey, .5)
    },
    [ActivityStatus.upcoming]: {
        color: COLORS.black,
        background: getAlpha(COLORS.green, .1),
        border: getAlpha(COLORS.green, .5),
    },
